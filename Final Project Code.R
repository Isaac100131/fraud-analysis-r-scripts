...
# 8.1 RMSE/R^2 calculations Since this is a binary classification problem
# RMSE/R^2 are not the most appropriate evaluation metrics but I included them
# here just in case. Just uncomment the code.
#actual <- ifelse(df$Is_Fraud == "Fraud", 1, 0)
